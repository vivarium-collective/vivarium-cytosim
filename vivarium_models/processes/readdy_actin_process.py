...
class ReaddyActinProcess(Process):
    ...
    def __init__(self, parameters=None):
        ...
        self.readdy_simulation, self.readdy_system = ActinUtil().create_actin_simulation(self.parameters)
