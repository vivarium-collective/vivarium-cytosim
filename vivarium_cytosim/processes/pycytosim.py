...
class PyCytosimProcess(Process):
    defaults = {
        ...
        "confine": None,
        "fibers_box_extent": np.array([1, 1, 1]),
    ...
    def __init__(self, parameters=None):
        ...
        self._render_template(
            init_fibers,
            self.parameters['fibers_box_extent'],
            self.parameters['timestep'])

        self.cytosim = cytosim.start(str(self.working_path / 'config.cym'))
    ...
    def _render_template(self, init_fibers, fibers_box_extent, timestep):
        fiber_sections = [
            PyCytosimProcess._fiber_section(id, fiber)
        ...
        cytosim_config = template.render(
            ...
            kT=PyCytosimProcess._temperature_to_kT(self.parameters["temperature"]),
